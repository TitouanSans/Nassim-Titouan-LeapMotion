...
// MURS OBSTACLES
const Cube_5 = new object ( (canvas.width / 2.5), 0, 100, canvas.height / 2, ''); 
const Cube_6 = new object ( (canvas.width / (10/6) ) - 50, canvas.height / 2, 100, canvas.height / 2, ''); 
...
*/
    ...
    if( collides(Joueur, Cube_5) ) {
        console.log('TOUCHER');
        Joueur.x = canvas.width / 4; 
        Joueur.y = canvas.height / 3;
    } 
    
    if( collides(Joueur, Cube_6) ) {
        console.log('TOUCHER');
        Joueur.x = canvas.width / 4; 
        Joueur.y = canvas.height / 3;
    } 
